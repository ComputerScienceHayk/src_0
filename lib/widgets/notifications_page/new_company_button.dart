...
class NewCompanyButton extends StatefulWidget {
  const NewCompanyButton({Key key}) : super(key: key);

  @override
  _NewCompanyButtonState createState() => _NewCompanyButtonState();
}

class _NewCompanyButtonState extends State<NewCompanyButton> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          Text("New company", style: TextStyle(fontSize: fullW * 0.05),),
          Switch(
            value: _isSwitched,
            onChanged: (value) {
              setState(() {
